...
<div class="container-fluid">
	...
	<hr/>
	<g:formRemote name="formProposta" url="[controller:'proposta', action:'cadastrar']" onSuccess="exibirMensagem(data)" class="form-group">
		<div class="row">
			<div class="col-md-12" style="margin-left: 25px">
				<div class="row">
					<div class="col-md-6">
						...
						<div class="input-group">
							...
							<g:select type="text" name="politico" from="${politica.Pessoa.list()}"  Value="${pessoa?.nome}"  class="form-control" >
				...
				<div class="row">
					<div class="col-md-6">
						...
						<div class="input-group">
							...
							<g:select type="text" name="area"  from="${politica.Area.list()}"  value="${areaInstance?.area?.id}" class="form-control" >
				...
				<div class="row">
					<div class="col-md-6">
						...
						<div class="input-group">
							...
							<textarea type="text" min="5" name="resumo" id="resumo"  placeholder="resumo"  required="" class="form-control">
							</textarea>
						</div>
				...
				<div class="row">
					<div class="col-md-6">
						...
						<div class="input-group">
							<textarea type="text" min="5" name="resumo" id="descricao"  placeholder="Descricao"  required="" class="form-control">
							</textarea>
						</div>
